...
const GERMAN: Record<string, string> = {
  ...
  "Connect Google for private mail and calendar access on this computer.": "Verbinden Sie Google für privaten E-Mail- und Kalenderzugriff auf diesem Computer.",
  "Email": "E-Mail",
  "Calendar": "Kalender",
  ...
  "Desktop, Documents and Downloads": "Desktop, Dokumente und Downloads",
  "Needed for “Hey JARVIS”": "Erforderlich für „Hey JARVIS“",
  "Spotify, Chrome & more": "Spotify, Chrome und mehr",
  "Say “open Chrome” or “open Spotify”": "Sagen Sie „Öffne Chrome“ oder „Öffne Spotify“",
  "Google Workspace": "Google Workspace",
  "Select Gmail or Google Calendar to open Google’s secure approval page. JARVIS receives access only after you approve it.": "Wählen Sie Gmail oder Google Kalender. Die sichere Google-Freigabe öffnet sich im Browser; JARVIS erhält erst nach Ihrer Bestätigung Zugriff.",
  "Connect Gmail": "Gmail verbinden",
  "Gmail via Google account": "Gmail über Google-Konto",
  "Unread senders/subjects and instructed sending": "Ungelesene Absender und Betreffzeilen; Versand nur auf Anweisung",
  "Connect Google Calendar": "Google Kalender verbinden",
  "Google Calendar via Google account": "Google Kalender über Google-Konto",
  "Read-only: upcoming events": "Nur lesen: kommende Termine",
  "Gmail metadata/sending and read-only Calendar access are enabled only after Google approval.": "Gmail-Metadaten und Versand sowie der Nur-Lese-Kalenderzugriff werden erst nach der Google-Freigabe aktiviert.",
  "App setup · seller only": "App-Einrichtung · nur Verkäufer",
  "Connect Google…": "Google verbinden…",
  "JARVIS never edits or deletes existing mail or calendar events. The account token stays in protected Windows storage and can be revoked here.": "JARVIS bearbeitet oder löscht keine bestehenden E-Mails oder Termine. Das Konto-Token bleibt im geschützten Windows-Speicher und kann hier widerrufen werden.",
  "READ ONLY": "NUR LESEN",
  "Ticket overview": "Ticket-Übersicht",
  "No clicks · no edits": "Keine Klicks · keine Änderungen",
  "Show ticket counts and a short summary from a public dashboard or from text you paste. JARVIS never signs in, clicks, submits, edits, or deletes anything.": "Zeigt Ticket-Anzahlen und eine kurze Zusammenfassung aus einem öffentlichen Dashboard oder eingefügtem Text. JARVIS meldet sich niemals an, klickt nichts an und verändert oder löscht nichts.",
  "Workspace name": "Arbeitsbereich",
  "Public HTTPS dashboard": "Öffentliches HTTPS-Dashboard",
  "Public pages only. Private or signed links, cookies, local addresses, and login sessions are blocked.": "Nur öffentliche Seiten. Private oder signierte Links, Cookies, lokale Adressen und Anmeldesitzungen sind gesperrt.",
  "or paste visible ticket text": "oder sichtbaren Ticket-Text einfügen",
  "Dashboard text": "Dashboard-Text",
  "Pasted text is analyzed locally and cleared after a successful result. It is not sent to your AI provider.": "Eingefügter Text wird lokal analysiert und nach einem erfolgreichen Ergebnis geleert. Er wird nicht an den KI-Anbieter gesendet.",
  "Analyze tickets": "Tickets analysieren",
  "Clear locally": "Lokal leeren",
  "Latest read-only snapshot": "Letzte Nur-Lese-Auswertung",
  "LOCAL SUMMARY": "LOKALE ZUSAMMENFASSUNG",
  "Total": "Gesamt",
  "Open": "Offen",
  "Pending": "Ausstehend",
  "Urgent": "Dringend",
  "New": "Neu",
  "Closed": "Geschlossen",
  "Read only · no cookies · no clicks · nothing sent to the AI provider": "Nur lesen · keine Cookies · keine Klicks · nichts an den KI-Anbieter gesendet",
  "Technical detail — raw permissions": "Technische Details — Systemberechtigungen",
  "Manage": "Verwalten",
  "Connect": "Verbinden",
