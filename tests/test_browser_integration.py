...
def _has_playwright_browser() -> bool:
    """Check for bundled Chromium or a supported system browser."""
    try:
...
PLAYWRIGHT_BROWSER_AVAILABLE = _has_playwright_browser()
...
@pytest.mark.asyncio
@pytest.mark.skipif(not (NETWORK_AVAILABLE and PLAYWRIGHT_BROWSER_AVAILABLE), reason=SKIP_REASON)
